                    ...
                    <div class="col-sm-5  ">
                        ...
                        <form action="/completeProfile" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="interests" id="exampleInputEmail1" placeholder="Your way of living life is .. " value={{$me['interests']}}>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1" class="sr-only">Speak your heart out .. </label>
                                <textarea class="form-control" name="bio" rows="3" placeholder="Speak your Heart out ...">{{$me['bio']}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1" class="sr-only">Looking for </label>
                                <input type="text" class="form-control" name="lookingFor" id="exampleInputPassword1" placeholder="Looking for" value="{{$me['lookingFor']}}">
                            </div>
